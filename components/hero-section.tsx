      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        >
          <div className="flex flex-col space-y-6">
            ...
            {/* Mobile Runmageddon 2025 button */}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center md:hidden">
          ...
          <div className="relative z-10 w-full max-w-sm rounded-2xl bg-background/95 p-6 shadow-xl backdrop-blur-md border border-white/10">
            ...
            <div className="space-y-4">
              ...
              {/* Mobile Runmagedon 2025 button */}
              <Button
                size="lg"
                className="relative w-full overflow-hidden rounded-full border-2 border-runmagedon bg-black/40 text-runmagedon backdrop-blur-sm shadow-[0_4px_15px_rgba(0,0,0,0.15)] px-6 py-3 transition-all hover:scale-105 hover:bg-black/50 animate-pulse-runmagedon w-[280px] h-[52px]"
                asChild
              >
                <a
                  href="https://book.plandok.com/pl/barberbus"
